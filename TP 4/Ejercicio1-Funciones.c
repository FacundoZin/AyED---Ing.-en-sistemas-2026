...
/*1) Escribir una función que reciba tres argumentos numéricos, que serán interpretados*/
/*	como límite inferior, límite superior e incremento de una serie de iteraciones.*/
/*	Imprimir la sucesión de enteros comprendidos entre ambos límites, de incremento*/
/*	en incremento. Controlar que el usuario ingrese los tres argumentos requeridos*/
/*	mayores a 0 y que límite superior sea mayor que limite inferior, abortando con un*/
